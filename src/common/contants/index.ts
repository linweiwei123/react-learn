...
export const FETCH_AGETNS_ALL = 'FETCH_AGETNS_ALL';
export const FETCH_AGETNS_ALL_FINISH = 'FETCH_ARTICLES_ALL_FINISH';

export const EFTCH_CHANGED_AGENT = 'EFTCH_CHANGED_AGENT';